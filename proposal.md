...
|CRUD dependiente|
1. CRUD Producto {depende de} Tipo_Kayak / Tipo_Articulo/ Tipo_Embarcacion/ Tipo_SUP <br> 2. CRUD Punto de entrega {depende de} Localidad| <br> 3. CRUD Localidad {depende de} Provincia
